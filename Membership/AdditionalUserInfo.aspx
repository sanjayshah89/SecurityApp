<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="AdditionalUserInfo.aspx.cs" Inherits="SecurityApp.Membership.AdditionalUserInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="UserProfileDataSource" runat="server" 
        ...
        SelectCommand="SELECT [UserId], [HomeTown], [HomepageUrl], [Signature] FROM [aspnet_UserProfiles] WHERE ([UserId] = @UserId)" 
