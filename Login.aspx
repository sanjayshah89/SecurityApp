<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SecurityApp.Login" %>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:HyperLink ID="CreateUserLink" runat="server" 
                                            NavigateUrl="~/Membership/CreatingUserAccounts.aspx">Not registered yet? 
